...
// FIXME  MC8zOmFIVnBZMlhsaUpqbWxvYzZlRmMyZGc9PToyODM5MTRmZQ==
        ...
        <CardHeader className="flex items-center justify-center space-y-2 pb-8 pt-6">
          <div className="flex flex-col items-center space-y-4">
            <div className="flex items-center gap-3">
              <img src="logo.svg" alt="AnythingChatRAG Logo" className="h-12 w-12" />
              <ZapIcon className="size-10 text-emerald-400" aria-hidden="true" />
            </div>
            <div className="text-center space-y-2">
              <h1 className="text-3xl font-bold tracking-tight">AnythingChatRAG</h1>
...
// FIXME  MS8zOmFIVnBZMlhsaUpqbWxvYzZlRmMyZGc9PToyODM5MTRmZQ==

export default LoginPage
// TODO  Mi8zOmFIVnBZMlhsaUpqbWxvYzZlRmMyZGc9PToyODM5MTRmZQ==
