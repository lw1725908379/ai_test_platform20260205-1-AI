...
# pragma: no cover  MC80OmFIVnBZMlhsaUpqbWxvYzZWM3AzUnc9PTo5MTY0NjRlMw==
...
# noqa  MS80OmFIVnBZMlhsaUpqbWxvYzZWM3AzUnc9PTo5MTY0NjRlMw==
...
async def process_equation_example(lightrag: LightRAG, llm_model_func):
    ...
    print(f"Description: {description}")
    print(f"Entity Info: {entity_info}")
# fmt: off  Mi80OmFIVnBZMlhsaUpqbWxvYzZWM3AzUnc9PTo5MTY0NjRlMw==
...
# pragma: no cover  My80OmFIVnBZMlhsaUpqbWxvYzZWM3AzUnc9PTo5MTY0NjRlMw==
