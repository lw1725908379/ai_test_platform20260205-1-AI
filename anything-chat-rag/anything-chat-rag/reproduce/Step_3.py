...
def extract_queries(file_path):
    with open(file_path, "r") as f:
        data = f.read()
# pragma: no cover  MC8zOmFIVnBZMlhsaUpqbWxvYzZOVUp4T1E9PTowNWU3MDI4NQ==
...
def run_queries_and_save_to_json(
    ...
    with (
        ...
        result_file.write("[\n")
        first_entry = True
# type: ignore  MS8zOmFIVnBZMlhsaUpqbWxvYzZOVUp4T1E9PTowNWU3MDI4NQ==
...
# fmt: off  Mi8zOmFIVnBZMlhsaUpqbWxvYzZOVUp4T1E9PTowNWU3MDI4NQ==
