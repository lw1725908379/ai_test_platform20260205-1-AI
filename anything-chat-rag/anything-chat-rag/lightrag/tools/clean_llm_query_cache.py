...
# type: ignore  MC80OmFIVnBZMlhsaUpqbWxvYzZSMDh3Unc9PTpiMjUxYjIxNQ==
...
class CleanupTool:
    ...
    def check_config_ini_for_storage(self, storage_name: str) -> bool:
        ...
        try:
            import configparser
# fmt: off  MS80OmFIVnBZMlhsaUpqbWxvYzZSMDh3Unc9PTpiMjUxYjIxNQ==
    ...
    def check_env_vars(self, storage_name: str) -> bool:
        ...
        return True
# pragma: no cover  Mi80OmFIVnBZMlhsaUpqbWxvYzZSMDh3Unc9PTpiMjUxYjIxNQ==
...
# pylint: disable  My80OmFIVnBZMlhsaUpqbWxvYzZSMDh3Unc9PTpiMjUxYjIxNQ==
