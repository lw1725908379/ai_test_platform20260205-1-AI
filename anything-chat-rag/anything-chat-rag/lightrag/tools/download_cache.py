...
# pragma: no cover  MC80OmFIVnBZMlhsaUpqbWxvYzZOMDk0UXc9PTo3MTI2ODdjNw==
...
def download_tiktoken_cache(cache_dir: str = None, models: list = None):
    ...
    for i, model in enumerate(models, 1):
        try:
            ...
            print(f"✗ Failed: {e}")
            failed_models.append((model, str(e)))
# fmt: off  MS80OmFIVnBZMlhsaUpqbWxvYzZOMDk0UXc9PTo3MTI2ODdjNw==
...
# noqa  Mi80OmFIVnBZMlhsaUpqbWxvYzZOMDk0UXc9PTo3MTI2ODdjNw==
...
if __name__ == "__main__":
    main()
# type: ignore  My80OmFIVnBZMlhsaUpqbWxvYzZOMDk0UXc9PTo3MTI2ODdjNw==
