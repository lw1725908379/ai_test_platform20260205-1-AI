...
import os
import logging
# type: ignore  MC80OmFIVnBZMlhsaUpqbWxvYzZZMDFQY2c9PTpkZThkOWVlOQ==
...
def create_openai_async_client(
    ...
    if use_azure:
        ...
        if client_configs is None:
            client_configs = {}
# pragma: no cover  MS80OmFIVnBZMlhsaUpqbWxvYzZZMDFQY2c9PTpkZThkOWVlOQ==
...
# noqa  Mi80OmFIVnBZMlhsaUpqbWxvYzZZMDFQY2c9PTpkZThkOWVlOQ==
            ...
            try:
                ...
                async for chunk in response:
                    ...
                    if not hasattr(chunk, "choices") or not chunk.choices:
                        ...
                        continue
# pylint: disable  My80OmFIVnBZMlhsaUpqbWxvYzZZMDFQY2c9PTpkZThkOWVlOQ==
