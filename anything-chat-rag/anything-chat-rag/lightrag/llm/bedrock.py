...
# type: ignore  MC80OmFIVnBZMlhsaUpqbWxvYzZNMFZHY1E9PTplYmY2NTFhNA==
...
def _handle_bedrock_exception(e: Exception, operation: str = "Bedrock API") -> None:
    ...
    # Custom Bedrock errors (already properly typed)
        ...
        raise
# pylint: disable  MS80OmFIVnBZMlhsaUpqbWxvYzZNMFZHY1E9PTplYmY2NTFhNA==
...
# fmt: off  Mi80OmFIVnBZMlhsaUpqbWxvYzZNMFZHY1E9PTplYmY2NTFhNA==
    ...
    async with session.client(
        ...
        try:
            ...
            return content
# pragma: no cover  My80OmFIVnBZMlhsaUpqbWxvYzZNMFZHY1E9PTplYmY2NTFhNA==
