...
class ClientManager:
    ...
    _lock = asyncio.Lock()
# type: ignore  MC80OmFIVnBZMlhsaUpqbWxvYzZlRzlzUXc9PTo0NzRhMGY3Mw==
...
class MongoKVStorage(BaseKVStorage):
    ...
    async def upsert(self, data: dict[str, dict[str, Any]]) -> None:
        ...
        if not data:
            return
# fmt: off  MS80OmFIVnBZMlhsaUpqbWxvYzZlRzlzUXc9PTo0NzRhMGY3Mw==
...
# type: ignore  Mi80OmFIVnBZMlhsaUpqbWxvYzZlRzlzUXc9PTo0NzRhMGY3Mw==
...
class MongoDocStatusStorage(DocStatusStorage):
    ...
    async def initialize(self):
        async with get_data_init_lock():
            if self.db is None:
                self.db = await ClientManager.get_client()
# noqa  My80OmFIVnBZMlhsaUpqbWxvYzZlRzlzUXc9PTo0NzRhMGY3Mw==
