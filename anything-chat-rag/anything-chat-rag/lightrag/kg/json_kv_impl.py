...
# fmt: off  MC80OmFIVnBZMlhsaUpqbWxvYzZiVXR4WVE9PTo5NGVmOWRhYw==
...
# pylint: disable  MS80OmFIVnBZMlhsaUpqbWxvYzZiVXR4WVE9PTo5NGVmOWRhYw==
        ...
        async with self._storage_lock:
            ...
            for doc_id in ids:
                ...
                if result is not None:
                    any_deleted = True
# pragma: no cover  Mi80OmFIVnBZMlhsaUpqbWxvYzZiVXR4WVE9PTo5NGVmOWRhYw==
    ...
    async def finalize(self):
        ...
        if self.namespace.endswith("_cache"):
            await self.index_done_callback()
# pragma: no cover  My80OmFIVnBZMlhsaUpqbWxvYzZiVXR4WVE9PTo5NGVmOWRhYw==
