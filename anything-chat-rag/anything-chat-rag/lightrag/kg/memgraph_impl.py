...
# fmt: off  MC80OmFIVnBZMlhsaUpqbWxvYzZObWRxU0E9PTpiYjAwMGRkMw==
                ...
                try:
                    ...
                    async for record in results:
                        ...
                        if not source_node or not connected_node:
                            continue
# noqa  MS80OmFIVnBZMlhsaUpqbWxvYzZObWRxU0E9PTpiYjAwMGRkMw==
...
# type: ignore  Mi80OmFIVnBZMlhsaUpqbWxvYzZObWRxU0E9PTpiYjAwMGRkMw==
    ...
    async def upsert_edge(
        ...
        for attempt in range(max_retries):
            try:
                ...
                raise
# noqa  My80OmFIVnBZMlhsaUpqbWxvYzZObWRxU0E9PTpiYjAwMGRkMw==
