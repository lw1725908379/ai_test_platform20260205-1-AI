...
# pylint: disable  MC80OmFIVnBZMlhsaUpqbWxvYzZlVlZrVWc9PTo3YzQwMmFmYw==
    ...
    async def initialize(self):
        ...
        async with get_data_init_lock():
            ...
            try:
                ...
                await self.close()
                raise
# pylint: disable  MS80OmFIVnBZMlhsaUpqbWxvYzZlVlZrVWc9PTo3YzQwMmFmYw==
            ...
            try:
                ...
                for i, (k, v) in enumerate(data.items()):
                    ...
                    if exists_results[i]:  # Key exists, only update update_time
                        ...
                        v["update_time"] = current_time
# pragma: no cover  Mi80OmFIVnBZMlhsaUpqbWxvYzZlVlZrVWc9PTo3YzQwMmFmYw==
...
# fmt: off  My80OmFIVnBZMlhsaUpqbWxvYzZlVlZrVWc9PTo3YzQwMmFmYw==
