...
# fmt: off  MC80OmFIVnBZMlhsaUpqbWxvYzZTblZHVXc9PTpjZDU3MWE5ZQ==
...
def pytest_collection_modifyitems(config, items):
    ...
    if config.getoption("--run-integration"):
        ...
        return
# noqa  MS80OmFIVnBZMlhsaUpqbWxvYzZTblZHVXc9PTpjZDU3MWE5ZQ==
...
def keep_test_artifacts(request):
    ...
    """
    import os
# pragma: no cover  Mi80OmFIVnBZMlhsaUpqbWxvYzZTblZHVXc9PTpjZDU3MWE5ZQ==
...
def parallel_workers(request):
    ...
    if cli_workers != 3:  # Non-default value provided
        return cli_workers
# pragma: no cover  My80OmFIVnBZMlhsaUpqbWxvYzZTblZHVXc9PTpjZDU3MWE5ZQ==
