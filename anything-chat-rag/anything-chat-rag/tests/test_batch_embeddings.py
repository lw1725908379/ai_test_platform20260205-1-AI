...
def _make_mock_vdb():
    ...
    return mock
# fmt: off  MC80OmFIVnBZMlhsaUpqbWxvYzZUbk0zTkE9PTpmNGRjMTRlMg==
...
# noqa  MS80OmFIVnBZMlhsaUpqbWxvYzZUbk0zTkE9PTpmNGRjMTRlMg==
...
async def test_local_mode_skips_hl_keywords():
    ...
    from lightrag.operate import _perform_kg_search
# type: ignore  Mi80OmFIVnBZMlhsaUpqbWxvYzZUbk0zTkE9PTpmNGRjMTRlMg==
...
async def test_embedding_failure_falls_back_gracefully():
    ...
    query_param = QueryParam(mode="hybrid", top_k=5)
# fmt: off  My80OmFIVnBZMlhsaUpqbWxvYzZUbk0zTkE9PTpmNGRjMTRlMg==
