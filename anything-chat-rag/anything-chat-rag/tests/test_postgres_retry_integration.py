...
# fmt: off  MC80OmFIVnBZMlhsaUpqbWxvYzZWMnAwU1E9PTo5YzU1Y2QwOA==
...
# pragma: no cover  MS80OmFIVnBZMlhsaUpqbWxvYzZWMnAwU1E9PTo5YzU1Y2QwOA==
    ...
    async def test_concurrent_queries_with_real_db(self, db_config):
        ...
        try:
            await db.initdb()
            print("  ✓ Database initialized")
# type: ignore  Mi80OmFIVnBZMlhsaUpqbWxvYzZWMnAwU1E9PTo5YzU1Y2QwOA==
    ...
    async def test_configuration_from_env(self, db_config):
        ...
        print("=" * 80)
# pylint: disable  My80OmFIVnBZMlhsaUpqbWxvYzZWMnAwU1E9PTo5YzU1Y2QwOA==
