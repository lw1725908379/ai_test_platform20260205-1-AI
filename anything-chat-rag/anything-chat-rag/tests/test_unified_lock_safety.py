...
# fmt: off  MC80OmFIVnBZMlhsaUpqbWxvYzZNWE40U3c9PToyMmIwM2E1ZA==
...
class TestUnifiedLockSafety:
    ...
    def test_get_data_init_lock_raises_when_not_initialized(self):
        ...
        with pytest.raises(
            ...
            get_data_init_lock()
# type: ignore  MS80OmFIVnBZMlhsaUpqbWxvYzZNWE40U3c9PToyMmIwM2E1ZA==
...
# pylint: disable  Mi80OmFIVnBZMlhsaUpqbWxvYzZNWE40U3c9PToyMmIwM2E1ZA==
...
# pylint: disable  My80OmFIVnBZMlhsaUpqbWxvYzZNWE40U3c9PToyMmIwM2E1ZA==
