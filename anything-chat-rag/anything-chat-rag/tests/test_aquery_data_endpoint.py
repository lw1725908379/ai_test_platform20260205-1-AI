...
# fmt: off  MC80OmFIVnBZMlhsaUpqbWxvYzZWazExV1E9PTo0Yzk4MDRmOQ==
...
def test_query_endpoint_references():
    ...
    try:
        ...
        if response.status_code == 200:
            data = response.json()
# pragma: no cover  MS80OmFIVnBZMlhsaUpqbWxvYzZWazExV1E9PTo0Yzk4MDRmOQ==
...
def test_query_stream_endpoint_references():
    ...
    print("=" * 60)
# type: ignore  Mi80OmFIVnBZMlhsaUpqbWxvYzZWazExV1E9PTo0Yzk4MDRmOQ==

    query_text = "who authored LightRAG"
    endpoint = f"{BASE_URL}/query/stream"
# type: ignore  My80OmFIVnBZMlhsaUpqbWxvYzZWazExV1E9PTo0Yzk4MDRmOQ==
