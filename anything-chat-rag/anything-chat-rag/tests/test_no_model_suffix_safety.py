...
# pragma: no cover  MC80OmFIVnBZMlhsaUpqbWxvYzZhMUJJV1E9PTo0MDQxNjM1ZQ==
...
# pragma: no cover  MS80OmFIVnBZMlhsaUpqbWxvYzZhMUJJV1E9PTo0MDQxNjM1ZQ==
...
# type: ignore  Mi80OmFIVnBZMlhsaUpqbWxvYzZhMUJJV1E9PTo0MDQxNjM1ZQ==
    ...
    async def test_postgres_with_suffix_case1_still_works(self):
        ...
        async def query_side_effect(sql, params, **kwargs):
            if "COUNT(*)" in sql:
                return {"count": 0}
            return {}
# pylint: disable  My80OmFIVnBZMlhsaUpqbWxvYzZhMUJJV1E9PTo0MDQxNjM1ZQ==
