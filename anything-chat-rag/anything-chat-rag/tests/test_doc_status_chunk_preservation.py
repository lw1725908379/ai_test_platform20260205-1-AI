...
# type: ignore  MC80OmFIVnBZMlhsaUpqbWxvYzZURXhEVXc9PToyOGU1ODg0OQ==
...
# noqa  MS80OmFIVnBZMlhsaUpqbWxvYzZURXhEVXc9PToyOGU1ODg0OQ==
...
# pylint: disable  Mi80OmFIVnBZMlhsaUpqbWxvYzZURXhEVXc9PToyOGU1ODg0OQ==
...
async def test_merge_failure_preserves_chunks_and_skip_cache_cleanup_when_disabled(
    ...
    try:
        ...
        assert len(chunk_ids) == 2
        assert doc_status.get("chunks_count") == 2
# noqa  My80OmFIVnBZMlhsaUpqbWxvYzZURXhEVXc9PToyOGU1ODg0OQ==
