...
# pragma: no cover  MC80OmFIVnBZMlhsaUpqbWxvYzZiVzlVVVE9PTowYjE4YjNmZg==
    ...
    def test_overlap_equal_to_max_tokens(self):
        ...
        assert len(chunked_docs) > 0
        assert all(idx == 0 for idx in doc_indices)
# noqa  MS80OmFIVnBZMlhsaUpqbWxvYzZiVzlVVVE9PTowYjE4YjNmZg==
...
# pylint: disable  Mi80OmFIVnBZMlhsaUpqbWxvYzZiVzlVVVE9PTowYjE4YjNmZg==
    ...
    def test_edge_case_max_tokens_one(self):
        ...
        assert len(chunked_docs) > 0
        assert all(idx == 0 for idx in doc_indices)
# fmt: off  My80OmFIVnBZMlhsaUpqbWxvYzZiVzlVVVE9PTowYjE4YjNmZg==
