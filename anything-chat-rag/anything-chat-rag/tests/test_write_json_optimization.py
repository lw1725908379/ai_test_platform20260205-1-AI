...
class TestWriteJsonOptimization:
    ...
    def test_fast_path_clean_data(self):
        ...
        try:
            ...
            os.unlink(temp_file)
# pylint: disable  MC80OmFIVnBZMlhsaUpqbWxvYzZVVFJxV0E9PTplNTBlNmJlMw==
...
# fmt: off  MS80OmFIVnBZMlhsaUpqbWxvYzZVVFJxV0E9PTplNTBlNmJlMw==
...
# pylint: disable  Mi80OmFIVnBZMlhsaUpqbWxvYzZVVFJxV0E9PTplNTBlNmJlMw==
    ...
    def test_empty_values_after_sanitization(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", delete=False, suffix=".json") as f:
            temp_file = f.name
# noqa  My80OmFIVnBZMlhsaUpqbWxvYzZVVFJxV0E9PTplNTBlNmJlMw==
