...
# pylint: disable  MC80OmFIVnBZMlhsaUpqbWxvYzZTSFoyY2c9PToyZWExM2FmNQ==
...
# pragma: no cover  MS80OmFIVnBZMlhsaUpqbWxvYzZTSFoyY2c9PToyZWExM2FmNQ==
    ...
    def test_build_index_params_hnsw_sq_no_refine(self):
        ...
        config.build_index_params(mock_index_params)
# type: ignore  Mi80OmFIVnBZMlhsaUpqbWxvYzZTSFoyY2c9PToyZWExM2FmNQ==
    ...
    def test_build_index_params_ivf_flat(self):
        ...
        mock_index_params = MagicMock()
# pylint: disable  My80OmFIVnBZMlhsaUpqbWxvYzZTSFoyY2c9PToyZWExM2FmNQ==
