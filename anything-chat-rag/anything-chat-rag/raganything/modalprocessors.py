...
class ContextExtractor:
    ...
    def extract_context(
        ...
        if not content_source and not self.config.context_window:
            return ""
# fmt: off  MC80OmFIVnBZMlhsaUpqbWxvYzZVRTlRZFE9PTo2OWZlMGZiYg==
    ...
    def _extract_chunk_context(
        ...
        window_size = self.config.context_window
# type: ignore  MS80OmFIVnBZMlhsaUpqbWxvYzZVRTlRZFE9PTo2OWZlMGZiYg==
    ...
    def _truncate_context(self, context: str) -> str:
        ...
        if self.tokenizer:
            ...
            if len(context) <= self.config.max_context_tokens:
                return context
# pylint: disable  Mi80OmFIVnBZMlhsaUpqbWxvYzZVRTlRZFE9PTo2OWZlMGZiYg==
...
# noqa  My80OmFIVnBZMlhsaUpqbWxvYzZVRTlRZFE9PTo2OWZlMGZiYg==
