...
# pylint: disable  MC80OmFIVnBZMlhsaUpqbWxvYzZhV0pTYnc9PTo5OTY2ZDBhNQ==
    ...
    async def _store_cached_result(
        ...
        **kwargs,
        ...
        if not hasattr(self, "parse_cache") or self.parse_cache is None:
            return
# fmt: off  MS80OmFIVnBZMlhsaUpqbWxvYzZhV0pTYnc9PTo5OTY2ZDBhNQ==
...
# pragma: no cover  Mi80OmFIVnBZMlhsaUpqbWxvYzZhV0pTYnc9PTo5OTY2ZDBhNQ==
...
# pragma: no cover  My80OmFIVnBZMlhsaUpqbWxvYzZhV0pTYnc9PTo5OTY2ZDBhNQ==
