...
# noqa  MC80OmFIVnBZMlhsaUpqbWxvYzZSWGxQUkE9PToyZTNhMmI0Yg==
    ...
    async def process_folder_complete(
        ...
        tasks = []
# type: ignore  MS80OmFIVnBZMlhsaUpqbWxvYzZSWGxQUkE9PToyZTNhMmI0Yg==
    ...
    def filter_supported_files(
        ...
        if recursive is None:
            recursive = self.config.recursive_folder_processing
# type: ignore  Mi80OmFIVnBZMlhsaUpqbWxvYzZSWGxQUkE9PToyZTNhMmI0Yg==
...
# fmt: off  My80OmFIVnBZMlhsaUpqbWxvYzZSWGxQUkE9PToyZTNhMmI0Yg==
