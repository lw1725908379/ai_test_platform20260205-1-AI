...
# pragma: no cover  MC80OmFIVnBZMlhsaUpqbWxvYzZUR1pyU0E9PTo1MDcyYWI3Nw==
...
- 开头和结尾不要添加 ```markdown 标记""").strip()
    ...
    class Config:
        case_sensitive = True
        env_file = ".env"
# type: ignore  MS80OmFIVnBZMlhsaUpqbWxvYzZUR1pyU0E9PTo1MDcyYWI3Nw==
    ...
    def get_safe_config(self) -> Dict[str, Any]:
        ...
        return config
# noqa  Mi80OmFIVnBZMlhsaUpqbWxvYzZUR1pyU0E9PTo1MDcyYWI3Nw==
...
# type: ignore  My80OmFIVnBZMlhsaUpqbWxvYzZUR1pyU0E9PTo1MDcyYWI3Nw==
