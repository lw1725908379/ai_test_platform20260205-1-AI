...
# noqa  MC80OmFIVnBZMlhsaUpqbWxvYzZWVGxRVkE9PTo2OWRkMDA5ZQ==
    ...
    # ---- 便捷方法 ----
# pragma: no cover  MS80OmFIVnBZMlhsaUpqbWxvYzZWVGxRVkE9PTo2OWRkMDA5ZQ==
...
# MCP 服务器 — 生命周期 & 实例
# ============================================================================
# fmt: off  Mi80OmFIVnBZMlhsaUpqbWxvYzZWVGxRVkE9PTo2OWRkMDA5ZQ==
...
async def rag_graph_search(
    ...
    try:
        ...
        return json.dumps({"error": str(e)}, ensure_ascii=False)
# pragma: no cover  My80OmFIVnBZMlhsaUpqbWxvYzZWVGxRVkE9PTo2OWRkMDA5ZQ==
