...
1. **AI测试Agent系统 (ai-test-agent-system)** - 基于DeepAgent框架的智能测试用例生成Agent
2. **Anything-Chat-RAG系统 (anything-chat-rag)** - 基于LightRAG的多模态RAG知识库服务
...
**入口配置** ([graph.json](vscode-webview://01po4keeec7vs70ehl2dju2ce838tjktkbo83ig67pftfgvclom1/ai-test-agent-system/ai-test-agent-system/graph.json)):
...
**核心Agent定义** ([agent.py](vscode-webview://01po4keeec7vs70ehl2dju2ce838tjktkbo83ig67pftfgvclom1/ai-test-agent-system/ai-test-agent-system/src/app/agents/testcase/agent.py)):
...
Agent内置7个Skills，位于 [skills目录](vscode-webview://01po4keeec7vs70ehl2dju2ce838tjktkbo83ig67pftfgvclom1/ai-test-agent-system/ai-test-agent-system/src/app/workspace/skills/):
...
**MCP RAG工具** (通过 [tools.py](vscode-webview://01po4keeec7vs70ehl2dju2ce838tjktkbo83ig67pftfgvclom1/ai-test-agent-system/ai-test-agent-system/src/app/agents/testcase/tools.py) 动态获取):
...
| 模块            | 文件                                                         | 功能        |
| --------------- | ------------------------------------------------------------ | ----------- |
| LightRAG Core   | [lightrag.py](vscode-webview://01po4keeec7vs70ehl2dju2ce838tjktkbo83ig67pftfgvclom1/anything-chat-rag/anything-chat-rag/lightrag/lightrag.py) | 核心RAG引擎 |
| Query Routes    | [query_routes.py](vscode-webview://01po4keeec7vs70ehl2dju2ce838tjktkbo83ig67pftfgvclom1/anything-chat-rag/anything-chat-rag/lightrag/api/routers/query_routes.py) | 查询API     |
| Document Routes | [document_routes.py](vscode-webview://01po4keeec7vs70ehl2dju2ce838tjktkbo83ig67pftfgvclom1/anything-chat-rag/anything-chat-rag/lightrag/api/routers/document_routes.py) | 文档管理API |
| Graph Routes    | [graph_routes.py](vscode-webview://01po4keeec7vs70ehl2dju2ce838tjktkbo83ig67pftfgvclom1/anything-chat-rag/anything-chat-rag/lightrag/api/routers/graph_routes.py) | 知识图谱API |
| RAGAnything     | [raganything.py](vscode-webview://01po4keeec7vs70ehl2dju2ce838tjktkbo83ig67pftfgvclom1/anything-chat-rag/anything-chat-rag/raganything/raganything.py) | 多模态处理  |
...
[MCP Server](vscode-webview://01po4keeec7vs70ehl2dju2ce838tjktkbo83ig67pftfgvclom1/ai-test-agent-system/ai-test-agent-system/src/app/mcp/rag_server.py) 提供:
...
[RAGMiddleware](vscode-webview://01po4keeec7vs70ehl2dju2ce838tjktkbo83ig67pftfgvclom1/ai-test-agent-system/ai-test-agent-system/src/app/middleware/rag_context.py) 实现:
...
1. **先RAG，后分析**: 任何需求必须先执行知识检索
2. **无依据不臆测**: 所有结论必须基于检索到的原始数据
3. **五大量化**: 预期结果必须具体可验证

### 6.2 RAG系统原则

1. **多模态**: 支持图像/表格/公式的文档处理
2. **可插拔存储**: 灵活选择存储后端
3. **多查询模式**: 根据场景选择最优检索策略
